...
public class NetworkUtils {
    ...
    private static final String API_KEY = "8907a6aa45f218e43159adc2a51521aa";
    private static final String SORT_BY_POPULARITY = "popularity.desc";
    private static final String SORT_BY_TOP_RATED = "vote_average.desc";
    private static final String MIN_VOT_COUNT_VALUE = "100";
    ...
    public static URL buildURL(int sortBy, int page, String lang) {
        ...
        Uri uri = Uri.parse(BASE_URL).buildUpon()
                ...
                .appendQueryParameter(PARAMS_MIN_VOTE_COUNT, MIN_VOT_COUNT_VALUE)
                .build();
        try {
